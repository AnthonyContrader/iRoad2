...
export default class Header extends Component {
  ...
  <header className="main-header">
    ...
    <a href="index2.html" className="logo">
      ...
      <span className="logo-lg"><b>Admin</b>Dashboard</span>
    </a>
      ...
      <div className="navbar-custom-menu">
        <ul className="nav navbar-nav">
              ...
              <li>
                ...
                <ul className="menu">
                  <li>{/* start message */}
                    <a href="fake_url">
                      <div className="pull-left">
                        <img src="dist/img/user2-160x160.jpg" className="img-circle" alt="User Immagine" />
                      </div>
                      <h4>
                        Support Team
                  ...
                  <li>
                    <a href="fake_url">
                      <div className="pull-left">
                        <img src="dist/img/user3-128x128.jpg" className="img-circle" alt="User Immagine" />
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="fake_url">
                      <div className="pull-left">
                        <img src="dist/img/user4-128x128.jpg" className="img-circle" alt="User Immagine" />
                      </div>
                      <h4>
                        Developers
                  ...
                  <li>
                    <a href="fake_url">
                      <div className="pull-left">
                        <img src="dist/img/user3-128x128.jpg" className="img-circle" alt="User Immagineage" />
                      </div>
                      <h4>
                        Sales Department
          ...
          <li className="dropdown user user-menu">
            <a href="fake_url" className="dropdown-toggle" data-toggle="dropdown">
              <img src="dist/img/Tutor.png" className="user-image" alt="User Immagine" />
              <span className="hidden-xs">Corinne Pepe</span>
            </a>
            <ul className="dropdown-menu">
              {/* User image */}
              <li className="user-header">
                ...
                <p>
                  Corinne Pepe - Software Developer
